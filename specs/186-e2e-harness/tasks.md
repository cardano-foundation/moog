...
- [ ] T186-SB E2E-test.yaml mirrors integration-tests.yaml: offchain checkout at the cabal.project-pinned rev (NOT main), devnet-server build, [self-hosted, moog], run on moog-v2; keep the cfhal MOOG_REQUESTER_WALLET secret setup; drop docker-compose/yaci/topup
- [ ] T186-SB remove test-E2E/fixtures/docker-compose.yml; update local-preprod.sh
- [ ] T186-SB proof: green E2E run on moog-v2 (self-hosted) against the pinned 0.2.0 server
